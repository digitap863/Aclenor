(function ($) {
    "use strict"; if ($(".scroll-to-target").length) { $(".scroll-to-target").on("click", function () { var target = $(this).attr("data-target"); $("html, body").animate({ scrollTop: $(target).offset().top }, 1000); return false; }); }
    ...
    if ($(".main-menu__list").length) {
        ...
        mainNavUL.find('li a[href^="#"]').on("click", function (e) {
    ...
    $("#accordion .collapse").on("shown.bs.collapse", function () { $(this).prev().addClass("active"); $(this).prev().parent().addClass("active"); }); $("#accordion .collapse").on("hidden.bs.collapse", function () { $(this).prev().removeClass("active"); $(this).prev().parent().removeClass("active"); }); $("#accordion").on("hide.bs.collapse show.bs.collapse", (e) => { $(e.target).prev().find("i:last-child").toggleClass("fa-plus fa-minus"); }); $(window).on("load", function () {
        ...
        const navLinks = $(".main-menu__list li a");
        ...
        sections.each(function () {
            ...
            if (scrollPos >= top && scrollPos <= bottom) {
                ...
                navLinks.closest("li").removeClass("current");
                $('.main-menu__list li.group a[href="#' + id + '"]').closest("li").addClass("current");
            }
        });
